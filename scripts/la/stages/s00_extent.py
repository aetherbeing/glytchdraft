"""
stages/s00_extent.py  [LA block pipeline]

Read LAZ header bounds (no point scan), reproject to EPSG:32611,
...
def run(tile: TileConfig) -> dict:
    """
    Returns:
      bbox_2229:  {minx, miny, minz, maxx, maxy, maxz}
      bbox_32611: {minx, miny, maxx, maxy}
      shift:      {x, y}  (SW corner rounded to nearest 1000 m in EPSG:32611)
    """
    ...
    return {"bbox_2229": bbox_2229, "bbox_32611": bbox_32611, "shift": {"x": shift_x, "y": shift_y}}
