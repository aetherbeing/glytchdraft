"""
export_city.py  [NYC city pipeline - GlitchOS.io]

Aggregate processed city tile outputs into a Blender-friendly export tree.

Usage:
    python scripts/nyc/export_city.py new_york_city
    python scripts/nyc/export_city.py new_york_city --merge-geometry
    python scripts/nyc/export_city.py new_york_city --keep-per-tile
    python scripts/nyc/export_city.py new_york_city --generate-blender_manifest
    python scripts/nyc/export_city.py new_york_city --merge-terrain
"""
...
def _merge_metadata(tiles: list[TileExport], out_path: Path, city_shift: dict) -> dict:
    ...
    out = {
        ...
        "name": "glitchos_nyc_city_building_masses",
...
def export_city(
    ...
    results: dict = {
        "schema_version": PIPELINE_VERSION,
        "pipeline": "GlitchOS.io NYC city export",
        "city_id": city_id,
